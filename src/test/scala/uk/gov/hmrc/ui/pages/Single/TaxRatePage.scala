...
object TaxRatePage extends BasePage {
  ...
  override def pageUrl: String = "/securities-transfer-charge/stf/tax-rate"

  sealed trait ConfirmationOption {
    def selector: String
  }

  case object HalfRate extends ConfirmationOption {
    val selector = "#value_0"
  }

  case object OneAndHalfRate extends ConfirmationOption {
