...
object ConfirmAddressPage extends BasePage {
  ...
  override def pageTitle: String =
    "Review and confirm your address - securities-transfer-charge-frontend - GOV.UK & Confirm the seller’s address - - GOV.UK & Confirm the buyer’s address - - GOV.UK & Review and confirm - - GOV.UK"
