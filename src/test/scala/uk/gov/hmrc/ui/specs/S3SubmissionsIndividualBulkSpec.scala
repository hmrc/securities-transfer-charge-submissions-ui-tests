...
import uk.gov.hmrc.ui.pages.BulkPages.{BulkEmptyPage, BulkErrorListPage, BulkFormattingPage, BulkTooManyErrorsPage, HowUseTemplateTransfersPage, TempPlaceholderFileUploadedPage, UploadFileTransfersPage}
import uk.gov.hmrc.ui.pages.{AboutYourSecuritiesTransfersPage, AuthWizard, CheckYourAnswersPage, SubmissionsDashboardPage}
import uk.gov.hmrc.ui.util.TestDataConstants.checkYourAnswers

class S3SubmissionsIndividualBulkSpec
