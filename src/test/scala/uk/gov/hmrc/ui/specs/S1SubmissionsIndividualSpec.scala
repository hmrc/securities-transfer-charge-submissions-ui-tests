...
import uk.gov.hmrc.ui.pages.individualPages.SecuritiesTypePage.{Other, Shares}
import uk.gov.hmrc.ui.pages.individualPages.TaxRatePage.{HalfRate, OneAndHalfRate}
